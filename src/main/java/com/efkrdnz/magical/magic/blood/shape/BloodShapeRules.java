...
public final class BloodShapeRules {
    ...
    public static final int MAX_FIELD_VOXELS = 1200;
     ...
     */
    public static double voxelPitch(double arcLengthBlocks, double wallHeight, int polylines) {
        ...
        for (int step = 0; step < 24; step++) {
            ...
            if (columns <= MAX_SPINE_POINTS && columns * rows <= MAX_FIELD_VOXELS) {
                return pitch;
            }
            pitch *= 1.25D;
        }
