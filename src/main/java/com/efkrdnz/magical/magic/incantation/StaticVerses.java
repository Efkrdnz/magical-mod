...
public final class StaticVerses {
    ...
    /** A standing body that carries a payload of {@code draw} verses, released by {@code kind}. */
    ...
    static void register(VerseCatalogue c) {
        ...
        c.register(carrier("held_word", 8, Verse.UNLIMITED, VersePrototypes.WORD_HELD, 3, PayloadKind.EPITAPH, 0, 3, s -> { }));
