...
public final class FxTextures {
    ...
    private static String emblemStrokes(EmblemId emblem) {
        return switch (emblem) {
            ...
            // The Sword six. Tip at +y throughout, as StampId.EDGE is, so a blade reads the same
            // way in an emblem as it does in a stamp.
            case STATION -> "L0,-0.35,0,0.9;L-0.1,0.62,0,0.9;L0.1,0.62,0,0.9;C0,-0.35,0.42;D0,-0.35,0.1";
            case AZIMUTH -> "C0,0,0.85;C0,0,0.28;L0,0.85,0,0.58;L0.85,0,0.58,0;L0,-0.85,0,-0.58;L-0.85,0,-0.58,0;D0.48,0.48,0.15";
            case KEEL -> "L-0.85,-0.4,0.85,-0.4;L0.85,-0.4,0.58,-0.18;L0.85,-0.4,0.58,-0.62;L0,-0.4,0,0.35;D0,0.62,0.24";
            case VOLLEY -> "L-0.85,0.55,0.5,0.07;L-0.85,0,0.5,0;L-0.85,-0.55,0.5,-0.07;L0.85,0,0.48,0.22;L0.85,0,0.48,-0.22";
            case UPTHRUST -> "L-0.9,-0.5,0.9,-0.5;L-0.52,-0.5,-0.52,0.32;L-0.63,0.08,-0.52,0.32;L-0.41,0.08,-0.52,0.32;L0,-0.5,0,0.85;L-0.12,0.55,0,0.85;L0.12,0.55,0,0.85;L0.52,-0.5,0.52,0.32;L0.41,0.08,0.52,0.32;L0.63,0.08,0.52,0.32";
            case GREATSWORD -> "L-0.17,-0.35,-0.17,0.5;L0.17,-0.35,0.17,0.5;L-0.17,0.5,0,0.88;L0.17,0.5,0,0.88;L-0.62,-0.35,0.62,-0.35;L0,-0.35,0,-0.82;D0,-0.88,0.15";
